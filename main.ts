...
export class DeepSeekTranslatorPlugin extends Plugin {
    ...
    async onload(): Promise<void> {
        console.log("🌐 Multi Translator: loading plugin");
        ...
        this.addRibbonIcon("languages", "Multi Translator", () => {
        ...
        console.log("🌐 Multi Translator: plugin loaded");
    }
    ...
    async loadSettings(): Promise<void> {
        ...
        // Migration: if old data doesn't have 'provider' field, default to 'deepseek'
